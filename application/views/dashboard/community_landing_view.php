            ...
            <div class="col-md-12">
                ...
                <div class="def-box-main" style="margin-top: 0;">
                    <div class="def-box-header">
                        <h5 class="pull-left" style="margin: 6px 25px 0 0;">SEO landing pages</h5>  <a href="<?php echo base_url() ?>communitylanding/create" class="btn btn-primary mp-btn-ico sm-primary pull-left" style="font-size: 12px;padding: 5px 15px;"><i class="fa fa-plus"></i> &nbsp; Add new landing</a>
                    ...
                    <div class="def-box-body">
                        ...
                        <form method="post" action="<?php echo base_url() ?>communitylanding">
                          ...
                          &nbsp;<a href="<?php echo base_url() ?>communitylanding">Clear search</a>
                          <?php endif; ?>
                    ...
                    <div class="table-responsive" style="overflow-x:auto;">
                        <table class="table table-striped tbl-user-list">
                          ...
                          <tbody>
                            ...
                            <?php foreach( $landingpages as $x ): 

                            ?>
                            <tr>
                                <th><input type="checkbox" name="chk[]"></th>
                                <th><strong>
                                  <a href="<?php echo base_url() ?>c/<?php echo $x['slug'] ?>" target="_blank" style="color:#263668;"><?php echo $x['title1'] ?></a></strong>
                                </th>
                                ...
                                <th>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu filter-frm-clr" aria-labelledby="dropdownMenuButton">
                                          <!-- <a class="dropdown-item" href="<?php echo base_url() ?>communitylanding/?view=<?php echo $x['info_page_id'] ?>">View</a> -->
                                          <a class="dropdown-item" href="<?php echo base_url() ?>communitylanding/?edit=<?php echo $x['info_page_id'] ?>">Edit</a>
                                          <a class="dropdown-item merejectmodal" href="<?php echo base_url() ?>communitylanding/?delete=<?php echo $x['info_page_id'] ?>">Delete</a>
                                        </div>
                                      </div>
                                </th>
