            ...
            <div class="col-md-12">
                ...
                <div class="def-box-main" style="margin-top: 0;">
                    <div class="def-box-header d-flex align-items-center">
                        <h5>Jobs</h5>
                        <a href="<?php echo base_url() ?>managejobs/createjobs" class="btn sm-btn sm-primary ml-auto">Create New Job</a>
                    </div>
                    <div class="def-box-body">
                        ...
                        <?php if( $this->session->userdata('hassearch') ): ?>
                          &nbsp;<a href="<?php echo base_url() ?>managejobs">Clear search</a>
                          <?php endif; ?>
                        <form method="post" action="<?php echo base_url() ?>managejobs">
                        ...
                        <table class="table table-striped tbl-user-list">
                          <thead>
                            <tr>
                              ...
                              <th width="30%" scope="col">Job Title</th>
                          ...
                          <tbody>
                            ...
                            <?php if( count($jobs) > 0 ): ?>
                            <?php foreach( $jobs as $ul ): ?>
                            <tr>
                                <!-- <th><input type="checkbox" name="chk[]" value="<?php echo $ul['account_id'] ?>"></th> -->
                                <th><?php echo substr($ul['title'],0,50) ?></th>
                                <th><?php echo $ul['job_type'] ?></th>
                                <th><?php echo $ul['location'] ?></th>
                                <th><?php echo $ul['company'] ?></th>
                                <th>
                                    <a href="<?php echo base_url() ?>jobs/<?php echo $ul['job_id'] ?>-<?php echo $ul['slug'] ?>" class="btn sm-primary mp-btn-ico sm-info" data-toggle="tooltip" data-placement="top" title="View Job"><i class="fa fa-eye"></i></a>

                                
                                    <a href="<?php echo base_url() ?>managejobs/edit?id=<?php echo $ul['job_id'] ?>" class="btn sm-primary mp-btn-ico sm-info" data-toggle="tooltip" data-placement="top" title="Edit Job"><i class="fa fa-edit"></i></a>

                                    <a href="<?php echo base_url() ?>managejobs?delete=<?php echo $ul['job_id'] ?>" class="btn sm-primary mp-btn-ico sm-info" onclick="return confirm('Are you sure you want to delete this job?');" data-toggle="tooltip" data-placement="top" title="Delete Job"><i class="fa fa-remove"></i></a>
                              ...
                              <?php else: ?>
                              <tr>
                                <th colspan="9" class="text-center" style="color: #777777;font-weight: 300;"><i>No jobs found</i></th>
                              </tr>
                              <?php endif; ?>
