            ...
            <div class="col-md-12">
                ...
                <div class="def-box-main" style="margin-top: 0;">
                    <div class="def-box-header d-flex align-items-center">
                        <h5>Modules</h5>
                        <a href="<?php echo base_url() ?>managemodules/createmodule?courseid=<?php echo $_GET['courseid'] ?>" class="btn sm-btn sm-primary ml-auto">Create New Module</a>
                    </div>
                    <div class="def-box-body">
                        ...
                        <?php if( $this->session->userdata('hassearch') ): ?>
                          &nbsp;<a href="<?php echo base_url() ?>managemodules">Clear search</a>
                          <?php endif; ?>
                        <form method="post" action="<?php echo base_url() ?>managemodules">
                    ...
                    <form action="<?php echo base_url() ?>managemodules" method="post">
                        ...
                        <table class="table table-striped tbl-user-list">
                          <thead>
                            <tr>
                              ...
                              <th width="30%" scope="col">Course</th>
                              <th width="20%" scope="col">Lessons</th>
                          ...
                          <tbody>
                            ...
                            <?php foreach( $modules as $ul ): ?>
                            <tr>
                                <!-- <th><input type="checkbox" name="chk[]" value="<?php echo $ul['account_id'] ?>"></th> -->
                                <th><?php echo $ul['module_title'] ?></th>
                                <th><?php echo $ul['course_title'] ?></th>
                                <th><?php echo $ul['lessons_count'] ?></th>
                                <th>
                                    
                                    <!-- <a href="<?php echo base_url() ?>managelessons/createlesson?moduleid=<?php //echo $ul['module_primary_id'] ?>" class="btn sm-primary mp-btn-ico sm-info" data-toggle="tooltip" data-placement="top" title="Add Lesson"><i class="fa fa-plus"></i></a> -->

                                    <a href="<?php echo base_url() ?>managemodules/edit?mid=<?php echo $ul['module_primary_id'] ?>&courseid=<?php echo $_GET['courseid'] ?>" class="btn sm-primary mp-btn-ico sm-info" data-toggle="tooltip" data-placement="top" title="Edit Module"><i class="fa fa-edit"></i></a>

                                    <a href="<?php echo base_url() ?>managemodules?courseid=<?php echo $this->session->userdata('mcourseid') ?>&delete=<?php echo $ul['module_primary_id'] ?>" class="btn sm-primary mp-btn-ico sm-info" onclick="return confirm('Are you sure you want to delete this module?');" data-toggle="tooltip" data-placement="top" title="Delete Module"><i class="fa fa-remove"></i></a>
                              ...
                              <?php else: ?>
                              <tr>
                                <th colspan="9" class="text-center" style="color: #777777;font-weight: 300;"><i>No modules found</i></th>
                              </tr>
                              <?php endif; ?>
