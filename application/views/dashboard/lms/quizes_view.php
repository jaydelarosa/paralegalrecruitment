            ...
            <div class="col-md-12">
                ...
                <div class="def-box-main" style="margin-top: 0;">
                    <div class="def-box-header d-flex align-items-center">
                        <h5>Quiz</h5>
                        <a href="<?php echo base_url() ?>managequizes/createquiz" class="btn sm-btn sm-primary ml-auto">Create New Quiz</a>
                    </div>
                    <div class="def-box-body">
                        ...
                        <?php if( $this->session->userdata('hassearch') ): ?>
                          &nbsp;<a href="<?php echo base_url() ?>managequizes">Clear search</a>
                          <?php endif; ?>
                        <form method="post" action="<?php echo base_url() ?>managequizes">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped tbl-user-list">
                          ...
                          <tbody>
                            ...
                            <?php foreach( $quizes as $ul ): ?>
                            <tr>
                                <!-- <th><input type="checkbox" name="chk[]" value="<?php echo $ul['account_id'] ?>"></th> -->
                                <th><?php echo $ul['question'] ?></th>
                                <th><?php echo $ul['course_title'] ?></th>
                               
                                <th>
                                   
                                    <a href="<?php echo base_url() ?>managequizes/edit?qid=<?php echo $ul['quiz_id'] ?>" class="btn sm-primary mp-btn-ico sm-info"><i class="fa fa-edit"></i></a>

                                    <a href="<?php echo base_url() ?>managequizes?delete=<?php echo $ul['quiz_id'] ?>" class="btn sm-primary mp-btn-ico sm-info" onclick="return confirm('Are you sure you want to delete this quiz?');"><i class="fa fa-remove"></i></a>
                              ...
                              <?php else: ?>
                              <tr>
                                <th colspan="9" class="text-center" style="color: #777777;font-weight: 300;"><i>No quiz found</i></th>
                              </tr>
                              <?php endif; ?>
