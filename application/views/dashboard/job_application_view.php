<div class="sm-container profile-sm-container">
    ...
    <!-- mentor applications -->
        ...
        <div class="sm-main-title" style="padding:0 0 0px 0;"><h5>Manage Job Applications</h5></div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div style="margin: 25px 0 0 0;" class="text-right">
                        <?php if( $this->session->userdata('role_id') == 2 ): ?>
                        <a href="#" class="btn btn-primary mp-btn" data-toggle="modal" data-target="#viewapplicationModal<?php echo $m['job_post_id'] ?>" mentor_id="<?php echo $m['account_id'] ?>"><i class="fas fa-eye"></i>&nbsp; View Application</a>

                            <?php if( $m['job_app_status']==0 ): ?>
                            <a href="<?php echo base_url() ?>jobapplication?ap=1&jid=<?php echo $m['job_application_id'] ?>" class="btn btn-primary mp-btn-ico sm-success meapprovemodal">
                                <!-- <i class="fa fa-check"></i> -->
                                Yes
                            </a>

                            <a href="<?php echo base_url() ?>jobapplication?ap=2&jid=<?php echo $m['job_application_id'] ?>" class="btn btn-primary mp-btn-ico sm-danger merejectmodal">
                                <!-- <i class="fa fa-remove"></i> -->
                                No
                            </a>
                            <?php endif; ?>
                        <?php else: ?>
                        <a href="<?php echo base_url() ?>jobapplication?a=submitplacement&jid=<?php echo $m['job_application_id'] ?>" class="btn btn-primary mp-btn submit-placement-btn" mentor_id="<?php echo $m['account_id'] ?>"><i class="fas fa-send"></i>&nbsp; Submit Placement</a>
                        <?php endif; ?>
        ...
        <?php if( $this->session->userdata('role_id') == 2 ): ?>
        <div class="empty-notif"><i>There are no job applications.</i></div>
        <?php elseif( $this->session->userdata('role_id') == 3 ): ?>
        <div class="empty-notif"><i>You currently have no job applications.</i></div>
        <?php endif; ?>
        ...
        <!-- submit placement modal -->
        <div class="modal fade" id="submitplacementModal" tabindex="-1" role="dialog" aria-labelledby="submitplacementModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body resign-content" style="padding-top: 0;">
                ...
                <div class="text-center">
                    <i class="fas fa-send" style="font-size: 38px;color: #40b660;font-weight: 300;"></i>
                    <h5>Submit Placement</h5>
                    <br/>
                    ...
                    <a href="#" class="btn sm-success ja-sp-btn" style="margin: 0 5px;">Submit</a>
