<div class="sm-container">
        ...
        <div class="browse-coach v3" style="display: none;">
            ...
            <div class="mobile-filter open">
                <div class="row" style="margin-top: 5px;">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="search" id="id_search" class="sm-no-shadow" placeholder="Name, Tags, Skills, ..." value="<?php echo $search; ?>">
                        ...
                        <div class="select" style="width: 100%">
                            ...
                            <select name="todo" id="todo" class="mb_16">
                            <option value="" selected="">Doesn't matter</option>
                            <option value="1" <?php echo $yesoption ?>>Yes</option>
                            <option value="2" <?php echo $nooption ?>>No</option>
                            </select>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb_16 select" style="width: 100%">
                            ...
                            <?php
                                ...
                                $location = '';
                                if( !empty($this->session->userdata('location')) ) { $location = $this->session->userdata('location'); }
                    ...
                    <div class="col-md-4">
                        ...
                        <?php
                            ...
                            $category = '';
                            if( !empty($this->session->userdata('category')) ) { $category = $this->session->userdata('category'); }
                        ...
                        <input class="sm-no-shadow" type="number" name="price" id="price" step="1.0" min="0.0" value="<?php echo $price ?>">
                        <br><br>
        ...
        <div class="freelancers-container freelancers-list-layout">
            ...
            <div class="freelancer">
                ...
                <div class="freelancer-overview">
                    <div class="freelancer-overview-inner">
                        ...
                        <div class="col-xl-10 col-lg-10">
                            ...
                            <!-- Name -->
                            <div class="freelancer-name" style="margin-left:0;">
                    ...
                    <div style="width: 100%"><p class="browsementor-bio">
                        <?php if( strlen($m['bio']) > 400 ): ?>
                        <?php echo substr($m['bio'], 0, 400)  ?>... <a class="read-more-btn" href="<?php echo base_url(); ?>coachprofile/<?php echo str_replace(' ', '', $m['first_name'].$m['last_name']).'-'.$m['account_id'] ?>">Read more</a>
                        <?php else: ?>
                        <?php echo nl2br($m['bio']) ?>
                        <?php endif; ?>
                    </p></div>
                ...
                <!-- Details -->
                <div class="d-flex freelancer-details align-items-center" style="padding: 0 0 2rem 0;min-height: 200px;">
                                <div class="align-items-stretch" style="padding: 0 1rem;width:100%;">

                        <?php //if( $m['sessions_only'] == 'no'): ?>
                            ...
                            <!-- <span class="tag is-small f_color_5" style="margin: 10px auto;background-color: #79D1B2;"><i class="fa fa-2x fa-tags is-size-6 f_color_5"></i> &nbsp;3 Day Trial</span> -->
                            <?php endif; ?>
                            <?php else: ?>
                            <!-- <span class="tag is-small f_color_5" style="margin: 10px auto;background-color: #79D1B2;"><i class="fa fa-2x fa-tags is-size-6 f_color_5"></i> &nbsp;3 Day Trial</span> -->
                            <?php endif; ?>
                            ...
                            ?>
                            <!-- <p class="browse-spot-indicator" class="is-hidden-touch"><?php //echo $spots_available ?> spots available</p> -->
                        ...
                        <?php //else: ?>
                            ...
                            <!-- <p id="price-indicator-detail">
                                <span>This coach only offers single sessions</span>
                            </p> -->
                        ...
                        <a class="blue-btn <?php echo $fbcls ?>"
                            style="padding: 8px 0; width: 100%; text-align: center; margin-top: 1em;"
                            href="<?php echo $mentorshipbtnhref; ?>"><b style="font-weight: 400;">&nbsp;<?php echo $mentorshipbtnlbl; ?>&nbsp;</b></a>
                        ...
                        <a class="blue-btn-outline"
                            ...
                            href="<?php echo base_url(); ?>coachprofile/<?php echo $mentorprofileslug ?>"><b style="font-weight: 400;">Visit Profile</b></a>

                        <!-- <a class="blue-btn-outline"
                            style="margin-top: 10px; padding: 8px 0; width: 100%; text-align: center"
                            href="<?php echo base_url(); ?>bookacallmentor/<?php echo $mentorprofileslug ?>"><b style="font-weight: 400;">Book a Call</b></a> -->
                        <?php else: ?>
                            <a class="blue-btn-outline"
                            style="margin-top: 10px; padding: 8px 0; width: 100%; text-align: center"
                            href="<?php echo base_url(); ?>coachprofile/<?php echo $mentorprofileslug ?>"><b style="font-weight: 400;">Visit Profile</b></a>
