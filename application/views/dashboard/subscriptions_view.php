                ...
                <div class="def-box-main" style="margin-top: 0;">
                    ...
                    <div class="def-box-body">
                        ...
                        <?php if( $this->session->userdata('hassearch') ): ?>
                          &nbsp;<a href="<?php echo base_url() ?>subscriptions">Clear search</a>
                          <?php endif; ?>
                        ...
                        <table class="table table-striped tbl-user-list">
                          <thead>
                            <tr>
                              ...
                              <th width="25%" scope="col">Voucher</th>
                          ...
                          <tbody>
                            ...
                            <?php foreach( $subscriptions_data as $ul ): ?>
                            <tr>
                                <th><?php echo $ul['first_name'] ?></th>
                                <th><?php echo $ul['last_name'] ?></th>
                                <th><?php echo $ul['voucher'] ?></th>
                                <th><?php echo $ul['email'] ?></th>
                              </tr>
                              <?php endforeach; ?>
                              <?php else: ?>
                              <tr>
                                <th colspan="9" class="text-center" style="color: #777777;font-weight: 300;"><i>No subscriptions found</i></th>
                              </tr>
                              <?php endif; ?>
