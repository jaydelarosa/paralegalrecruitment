<div class="containerx">
                                    ...
                                    <div class="msgboxvh">
                                        <div class="inbox">
                                            <div class="curr-chat-boxes in-box">
                                                ...
                                                $mentorship_tag_f = '<span class="chat-subtype-tag mentorship-tag">Coaching</span>';
                                                ...
                                                $mentorprofileslug = str_replace(' ', '', str_replace('-', '',$x['first_name'].$x['last_name'])).'-'.$x['user_id'];
                                            ...
                                            <div style="padding: 0 0 0 0;">
                                                ...
                                                <!-- <a href="<?php echo base_url() ?>browsementor">
                                                    <div class="chat-name">
                                                       <span style="font-size:14px;">Find a Coach</span>
                                                    </div>
                                                </a> -->
                                                <?php endif; ?>
                                                ...
                                                <!-- <button type="button" data-toggle="modal" data-target="#contactadminModal" class="btn btn-primary cm-btn btn-block getchatx a-chat-name-0 first-active-chat-boxx" subtype="contactadmin" fromid="0" caseno="<?php echo $caseno ?>" typeofchat="1" style="margin: 30px 0 0 0;font-size: 12px;text-transform: none;"> <i class="fas fa-question-circle"></i> &nbsp;&nbsp;Contact Admin</button> -->


                                                <!-- contact admin box modal -->
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body" style="padding-top: 0;">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="frm-blockx">
                                                                            <div class="frm-lbl text-left"><b>Title</b></div>

                                                                            <input type="text" class="form-control contact_title" name="contact_title" autofocus>
                                                                        </div>
                                                                    </div>
                                                                </div><br/>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="frm-blockx">
                                                                            <div class="frm-lbl text-left"><b>Email</b></div>

                                                                            <input type="text" class="form-control contact_email" name="contact_email" value="<?php echo $user_account[0]['email'] ?>">
                                                                        </div>
                                                                    </div>
                                                                </div><br/>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="frm-blockx">
                                                                            <div class="frm-lbl text-left"><b>Message</b></div>

                                                                            <textarea class="form-control contact_message" name="contact_message" style="height:130px;"></textarea>
                                                                        </div>
                                                                    </div>
                                                                </div><br/>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <input type="hidden" name="contact_role_type" class="contact_role_type" value="<?php echo ($this->session->userdata('role_id')==2) ? 'Coach' : 'Mentee' ;  ?>">
                                                                        <button type="button" class="btn btn-primary cm-btn btn-block btn-load send-contact-btn" data-loading-text="Sending.." style="margin-right: 35px;">Send Message</button>
                                                                    </div>
                                                                </div>
 ...
 -->
                        ...
                        <div class="dash-mid-box p2" curr="<?php echo ($chatallowed == 1) ? 'chats' : 'subs' ; ?>" style="display: none;">

                            <!-- chat box -->
                            <div class="chat-messages">
                                <div class="chat-messages-inner chat-messages-contents p2" <?php echo ($chatallowed == 0) ? 'style="height:auto;"' : 'height: calc(100% - 165px);' ; ?>>

                                <?php if($chatallowed == 1): ?>
                                    <div class="load-more-msg-btn load-prev-chat-box-12">Load previous messages</div>
                                    ...
                                    <div class="message-container message-right xxx <?php echo $taskmessagecontainer ?>">
                                        ...
                                        <span class="unsendchat unsendchat-<?php echo $x['chat_id']; ?>" chatid="<?php echo $x['chat_id']; ?>" style="margin-top: 5px;">Unsend</span>
                                                ...
                                                <div class="row sub-payment-info">
                                                    <div class="col-md-8 offset-md-2">
                                                        ...
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-4">
                                                              <label>CVC</label>
                                                              <input type="text" name="cvc" class="form-control cvc" maxlength="3" value="<?php echo $cvc; ?>" required>
                                                            </div>
                                                          </div>

                                                        <div class="checkbox remember subscription-checkbox iagreebox">
                                                            <label><input type="checkbox" name="iagreesub" class="iagreesub" required=""> I agree to the <a href="<?php echo base_url() ?>termsandconditions" target="_blank">Terms & Conditions</a></label>
                                ...
                                <div class="chat-box-class chat-write-box" <?php echo ($chatallowed == 0) ? 'style="display:none"' : 'position: relative;height: 150px;' ; ?>>
                ...
                ?>
                <div class="profile-container sub-prof-box p2 right-active" <?php echo $hiderightsub ; ?>> <!-- profile-container -->
                    ...
                    <div class="dash-profile-box">
                        ...
                        <div class="profile-details">
                            <div class="dash-side-dates mentee-sub-details" <?php echo ($subtype=='booking') ? 'style="display:none;"' : '' ; ?>>
                                <?php if( $prf_mentorship_type == 'Coaching' ): ?>
                                    <h4><?php echo $prf_mentorship_type ?></h4><div class="start-date"><span>End Date</span><span class="prf-start-date"><?php echo date('F d, Y', strtotime($prf_mentorship_sub)) ?></span></div>
                                <?php else: ?>
                                    <h4><?php echo $prf_mentorship_type ?></h4><div class="start-date"><span>Duration</span><span class="prf-start-date"><?php echo $prf_mentorship_sub ?></span></div>
                                <?php endif; ?>
                            </div><br/>
                            ...
                            <div>
                            <a href="#" user_id="<?php echo $chatsfrom[0]['user_id'] ?>" class="btn btn-block sm-primary endsessionModalbtn" style="padding: 7px 40px;text-transform: none;font-size: 12px;">End Booking</a>
                            </div>
                                  ...
                                  <div class="card acid-new-task>">
                                    ...
                                    <div id="collapseOne-new-task" class="collapse" aria-labelledby="headingOne-new-task" data-parent="#accordion">
                                        <div class="card-body fs_12">
                                            ...
                                            <?php if(count($admin_tasks)>0): ?>
                                            
                                            <select class="form-control m-time-type task_dropdown" readonly>
                                                <?php foreach( $admin_tasks as $tsks ): ?>
                                                <option value="<?php echo $tsks['task_id']; ?>"><?php echo $tsks['title']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                            ...
                                            <button type="button" class="btn btn-block btn-success createactivityajax2" fromid="<?php echo $tochatmessage ?>" style="margin: 15px 0 10px 0;">Create Task</button>
                                            ...
                                            <div style="display: none;">
                                                ...
                                                <form action="#" class="createactivityajaxform">
                                                    ...
                                                    <input type="hidden" name="fileformname" class="fileformname" value="taskfileattachment">
                    ...
                    <div class="dash-profile-box">
                        ...
                        <div class="profile-name">
                            <h3 class="prf-name"><?php echo $chatsfrom[0]['first_name'] ?> <?php echo $chatsfrom[0]['last_name'] ?></h3>
                            <span><?php echo $chatsfrom[0]['job_title'] ?></span>
                        </div>
                        <div class="profile-details">
                            <div class="dash-side-dates" <?php echo ($subtype=='booking') ? 'style="display:none;"' : '' ; ?>>
                                <!-- <h4>Coach from</h4>
                           ...
                           <!-- <a href="#" user_id="<?php echo $chatsfrom[0]['user_id'] ?>" class="btn sm-primary viewprofileModalbtn viewprofilebtn" style="padding: 7px 40px;text-transform: none;font-size: 12px;<?php echo ($subtype=='booking') ? 'display:none;' : '' ; ?>">View</a> -->
                            <?php 
                                $mentorprofileslug = str_replace(' ', '', str_replace('-', '',$chatsfrom[0]['first_name'].substr($chatsfrom[0]['last_name'], 0,1))).'-'.$chatsfrom[0]['user_id'];
                            ?>

                            <?php if( $notif != ''): ?>
                            <div class="f_500 alert alert-<?php echo $notif_type; ?>" role="alert" style="border-radius:22px;padding:6px 20px;font-size:13px !important;">
                            <?php echo $notif; ?>
                            </div>
                            <?php endif; ?>
                            ...
                            <?php if( $this->session->userdata('role_id') == 2 ): ?>
                            <div>
                            <a href="#" user_id="<?php echo $chatsfrom[0]['user_id'] ?>" class="btn btn-block sm-primary sendchatnotificationModalbtn" style="padding: 7px 20px;text-transform: none;font-size: 12px;margin-top:14px;">Send a reply reminder</a>
                            </div>
                            <?php endif; ?>

                            <div>
                            <a href="<?php echo base_url() ?>coachprofile/<?php echo strtolower($mentorprofileslug) ?>" target="_blank"  class="btn btn-block sm-primary dash-view-m-profile" style="padding: 7px 40px;text-transform: none;font-size: 12px;margin-top:14px;<?php echo ($subtype=='booking') ? 'display:none;' : '' ; ?>">View</a>
                            </div>
                            
                            <div>
                            <a href="#" user_id="<?php echo $chatsfrom[0]['user_id'] ?>" class="btn btn-block sm-primary endsessionModalbtn" style="padding: 7px 40px;text-transform: none;font-size: 12px;margin-top:14px;">End Booking</a>
                            </div>
                        ...
                        <div class="def-box-body" style="padding: 0px;">
                            ...
                            <table class="sub-sum-tbl" width="100%">
                                <tr class="sub-sum-details">
                                    <tr>
                                        <td colspan="2"><div class="btn btn-success" style="width:100%;background-color:#49d04a;border:0;text-transform:none;">3 day trial</div></td>
                                    </tr>
                                    <td width="70%">
                                        After 3 day trial<br/>Monthly mentorship <?php echo $chatsfrom[0]['first_name'] ?> <?php echo $chatsfrom[0]['last_name'] ?>
                                    </td>
            ...
            <!-- profile box modal -->
              ...
              <!-- end profile box modal -->
                ...
                <div class="modal fade" id="sendchatnotificationModal" tabindex="-1" role="dialog" aria-labelledby="sendchatnotificationModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                      ...
                      <div class="modal-body resign-content" style="padding-top: 0;">
                        ...
                        <div class="text-center">
                            <i class="fas fa-paper-plane" style="font-size: 38px;color:#1bd499;"></i>
                            <h5>Send a reply email reminder</h5>
                            <br/>
                            ...
                            <a href="#" class="btn btn-primary cm-btn send-notification-btn" style="margin: 0 5px;">Yes</a>
