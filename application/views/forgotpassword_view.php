                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                       ...
                       <div class="login_info col-lg-8  d-flex" style="height: 100vh;">
                        <div class="align-items-center my-auto" style="margin-left: 25px;">

                            <h1 class="f_size_26 f_600 mb_10">Reset your password</h1>
                            <p class="f_size_16 gilroy_medium f_color_20 mb_30">Enter the email associated with your accoount and we’ll send an email with instructin to reset your password.</p>
                            ...
                            <form action="<?php echo base_url() ?>forgotpassword" method="post" class="v3">
                                ...
                                <input type="hidden" name="mentee_application_view-current_step" value="0"
                                 ...
                                 <div class="form-group mb_20">
                                    <label class="f_size_16 mb0">Email Address</label>
                                    <div class="form-group has-login">
                                        <!-- <img src="<?php echo base_url() ?>img/sms2.png" class="form-control-login"> -->
                                        <input type="text" class="bg_color_EEF2F8 sm-no-shadow border-radius-8 mb0 gilroy_medium" id="email" name="email" placeholder="Enter email address" style="border:0 !important; padding-left: 20px;height:48px;" required="" id="id_0-email" value="<?php echo $this->input->cookie('sm_remember_email',TRUE)  ?>" autofocus>
                                    </div>

                                </div>

                                <button type="submit" class="btn btn-heyrec">Reset Password</button>
